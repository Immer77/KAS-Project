...
public class DeltagerPane extends GridPane {
    ...
    public DeltagerPane(){
        ...
        ChangeListener<Konference> konferenceChangeListener = (oK, oldKonference, newKonference) -> this.KonferenceSelectionChanged();
        ...
        for (Arrangement a : Controller.getarrangementer()){
            ...
            rb.setText(a.getTitel() + " " + a.getDato() + " " + a.getPris() + " Kr.");
        }
    ...
    private void KonferenceSelectionChanged() {
...
//            alert.setHeaderText("Mangler input i tekstfelter");
//            alert.show();
//        }
        Deltager d1 = Controller.createDeltager(txfNavn.getText(),txfAdresse.getText(), Integer.parseInt(txfTlfNr.getText()), chBoxForedragsHolder.isSelected(), txfFirmaNavn.getText(), Integer.parseInt(txfFirmaTlf.getText()));
        if(chBoxLedsager.isSelected()){
